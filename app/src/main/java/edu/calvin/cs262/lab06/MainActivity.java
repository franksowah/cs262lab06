 ...
 *
 *
 * Q1. When anything numbers are put into the text field, the app shows a toast that indicates that it failed to connect. I also realized, by inputing wrong cities that
 *      the app still shows weather for these "very fake" inputs.
 *
 * Q2.What is the API key? What does it do?
